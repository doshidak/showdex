...
declare class HtmlRoom implements Showdown.ClientRoom {
  public id: string;
  public cid: string;
  public type: Showdown.ClientRoomType = 'html';
  public title = 'Page';
  ...
  public focus(): void;
  public blur(): void;
  public show(position?: Showdown.ClientRoomPosition, leftWidth?: number): void;
  public hide(): void;
