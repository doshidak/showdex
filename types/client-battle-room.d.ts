...
declare class BattleRoom implements Showdown.ClientRoom {
  public id: string;
  public cid: string;
  public type: Showdown.ClientRoomType = 'battle';
  public title = '';
  ...
  public battle: Showdown.Battle;
  public users: Record<string, Showdown.ClientUser>;
  public userCount: { users: number; } = { users: 0 };
  public chatHistory: { index: number; lines: string[] };

  public choice?: Showdown.ClientBattleChoice;
  public request?: Showdown.BattleRequest;
  ...
  public displayParty(switchables: Partial<Showdown.Pokemon>[], trapped?: boolean): void;
  ...
  public receiveRequest(request: Showdown.BattleRequest, choiceText?: boolean): void;
  public notifyRequest(): void;
  public updateSideLocation(): void;
  public updateSide(): void;
  public addAlly(allyData?: Showdown.Side): void;
