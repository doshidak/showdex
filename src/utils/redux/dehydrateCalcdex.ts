...
import type { CalcdexBattleState, CalcdexPlayerSide } from '@showdex/redux/store';
 ...
 * @since 1.0.3
 */
const dehydrateBoolean = (value: boolean): string => (value ? 'y' : 'n');
 ...
 * @since 1.0.3
 */
const dehydrateValue = (value: unknown): string => (
